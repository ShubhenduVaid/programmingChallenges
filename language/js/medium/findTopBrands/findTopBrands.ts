export const findTopBrands = {
  name: `Find Top Brands`,
  description: `You would like to make a list of N top brand names based on user preferences. You are supplied with data about users containing id and gender information.
  ...
  solution: `function getLikedBrands(id) {
